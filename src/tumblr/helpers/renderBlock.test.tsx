...
describe('renderBlock', () => {
	it('should return a react component', () => {
		...
		expect(output.html()).toBe('{block:Test}{/block:Test}')
    })
    ...
    it('should set the react component display name', () => {
        ...
        expect(Component1.displayName).toBe('TestBlock')
        expect(Component2.displayName).toBe('AnotherTestBlock')
    })
    ...
    it('should render children', () => {
		...
		expect(output.html()).toBe('{block:Test}testing{/block:Test}')
    })
    ...
    it('should render prop names and values to string inside the first tag', () => {
		...
		expect(output.html()).toBe('{block:Test value=&quot;35&quot;}testing{/block:Test}')
    })
})
